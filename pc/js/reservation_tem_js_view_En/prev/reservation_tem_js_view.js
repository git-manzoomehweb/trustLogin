...
if (document.querySelector(".message-box-nodata")) {
    ...
    if (document.querySelector(".message-box-nodata").getAttribute("data-error-code")) {
        if (document.querySelector(".message-box-nodata").getAttribute("data-error-code") == 19) {
            const provider_json = [{
                name: "تریپ سنتر",
                dmnid: 4483
            }, {
            ...
            let total = 0;
            let d = new Date();
            let time = d.getHours().toLocaleString('fa-IR') + ":" + d.getMinutes().toLocaleString('fa-IR') + ":" + d.getSeconds().toLocaleString('fa-IR');
            let provider = JSON.parse(document.querySelector(".invoice-form").querySelector("input[name=mainprovider]").value).dmnid;
            let main_provider = "";
            if (typeof provider == 'string') {
                let provider_splited = provider.split("-");
                main_provider = provider_splited[0];
            } else {
                main_provider = provider
            }
            let provider_name = "";
            for (const element of provider_json) {
                if (element.dmnid == main_provider) {
                    provider_name = element.name
                }
            }
            if (document.querySelector(".prices-detail-content")) {
                document.querySelector(".prices-detail-content").querySelectorAll(".body-content").forEach(e =>
                    total += parseInt(e.getElementsByTagName("div")[2].querySelector(".separate").innerHTML)
                );
            } else {
                total = document.querySelector(".message-box-nodata").getAttribute("data-amount");
                total = total.replace(/,/g, '');
            }
            $.post(`/Client_Credit_Message.bc`, {
                type: module_fa,
...
for (var i = 0; i < document.getElementsByClassName('reSearch-form').length; i++) {
    if (document.getElementsByClassName('reSearch-form')[i].getAttribute("data-engine") == 1) {
        document.getElementsByClassName('reSearch-form')[i].setAttribute("action",
            `/${module}_engine__EN.bc`);
        if ($(window).width() <= 750) {
            document.getElementsByClassName('reSearch-form')[i].setAttribute("action",
                `/M_${module}_Engine_Search_EN.bc`);
        }
    } else {
        if ($(window).width() <= 750) {
            document.getElementsByClassName('reSearch-form')[i].setAttribute("action",
...
function show_flight_rule(element) {
    ...
    obj["adults"] = parseInt(document.querySelector(".invoice-form").querySelector("input[name=adultcount]").value);
    obj["childs"] = parseInt(document.querySelector(".invoice-form").querySelector("input[name=childcount]").value);
    obj["infant"] = parseInt(document.querySelector(".invoice-form").querySelector("input[name=infantcount]").value);
    delete obj["bar_info"];
...
if (document.querySelector(".main-container").getAttribute("data-schemaid") == 290 || document.querySelector(".main-container").getAttribute("data-schemaid") == 291 || document.querySelector(".main-container").getAttribute("data-schemaid") == 292 || document.querySelector(".main-container").getAttribute("data-schemaid") == 139 || document.querySelector(".main-container").getAttribute("data-schemaid") == 500 || document.querySelector(".main-container").getAttribute("data-schemaid") == 401 || document.querySelector(".main-container").getAttribute("data-schemaid") == 402 || document.querySelector(".main-container").getAttribute("data-schemaid") == 501) {
    ...
    for (var i = 0; i < schema.length; i++) {
        ...
        element_title.className = "title flex-justify font_14 testtt";
    ...
    <li onclick="select_date_val(this)" class="li-item" data-id="2045" data-value="2045">2045</li>
                    ...
                    <li onclick="select_area_val(this)" class="li-item" data-value="United States" data-id="1002211">United States</li>
    ...
    for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".day").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
        data_day.push({
            "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".day").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
            "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".day").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
        })
    };
    for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".month").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
        data_month.push({
            "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".month").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
            "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".month").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
        })
    };
    for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
        data_year_birthdate.push({
            "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
            "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`
    ...
    if (document.getElementsByClassName("passenger-info-content")[0].querySelector(".passexpiredate")) {
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".passexpiredate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_year_passport.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".passexpiredate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".passexpiredate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`
    ...
    if (document.querySelector(".nationalityCo")) {
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".nationalityCo").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_area.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".nationalityCo").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".nationalityCo").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
            })
        };
    }
    if (document.querySelector(".countryofresistance")) {
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".countryofresistance").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_area.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".countryofresistance").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".countryofresistance").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
            })
        };
    }
    ...
    if (document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday")) {
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".day").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_day.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".day").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".day").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
            })
        };
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".month").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_month.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".month").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".month").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
            })
        };
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_year_birthdate.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".birthday").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`
            })
        };
    }
    // add if end
    if (document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".passexpiredate")) {
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".passexpiredate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_year_passport.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".passexpiredate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".passexpiredate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`
            })
        }
    };
    // add if start
    if (document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".countryofresistance")) {
        for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".countryofresistance").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
            data_area.push({
                "date_value": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".countryofresistance").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                "date_id": `${document.getElementsByClassName("passenger-info-content")[0].getElementsByClassName("passenger")[0].querySelector(".countryofresistance").closest(".package-info-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`,
            })
        }
    }
    // add if end
...
function autoComplete_search(event, element, type) {
    ...
    if (type == 'day') {
        var filterd_date = data_day.filter((item, i) => {
            return item.date_value.includes(searched_value);
        });
        ...
        var filterd_date = data_area.filter((item, i) => {
            return item.date_value.toUpperCase().includes(searched_value.toUpperCase());
        });
        renderData(filterd_date, type, element);
...
function renderData(arrayOfData, type, element) {
    ...
    if (type == 'area') {
        for (let i = 0; i < arrayOfData.length; i++) {
            li_list += `<li onclick="select_area_val(this)" class="li-item" data-id="${arrayOfData[i].date_id}" data-value="${arrayOfData[i].date_value}">${arrayOfData[i].date_value}</li>`;
        }
        ...
        for (let i = 0; i < arrayOfData.length; i++) {
            li_list += `<li onclick="select_date_val(this)" class="li-item" data-id="${arrayOfData[i].date_id}" data-value="${arrayOfData[i].date_value}">${arrayOfData[i].date_value}</li>`;
        }
            ...
            if (isExist) {
                ...
                if (isValid) {
                    ...
                    if (document.querySelector(".check-has-data")) {
                        if (document.querySelector(".check-has-data").querySelector(".firstname").getAttribute("data-value") == "" || document.querySelector(".check-has-data").querySelector(".lastname").getAttribute("data-value") == "" || document.querySelector(".check-has-data").querySelector(".mobile").getAttribute("data-value") == "") {
                            $.post('/Client_SaveInfo.bc', {
                                Firstname: document.querySelector(".check-has-data").querySelector(".firstname").value,
                                Lastname: document.querySelector(".check-has-data").querySelector(".lastname").value,
                                Tell: document.querySelector(".check-has-data").querySelector(".tel").value,
                                Mobile: document.querySelector(".check-has-data").querySelector(".mobile").value,
                                Address: document.querySelector(".check-has-data").querySelector(".address").value,
                                email: document.querySelector(".check-has-data").querySelector(".email").value,
                            }, function (response) {
                                console.log(response)
                            });
                        };
            ...
            if (isExist) {
                ...
                for (var i = 0; i < rooms.rooms.length; i++) {
                    ...
                    for (var j = 1; j < child_count_age_splited.length; j++) {
                        if (child_count_age_splited[j] > 2 && child_count_age_splited[j] <= 6) {
                            child_age_wob = child_age_wob += child_count_age_splited[j] + ',';
                            console.log("child_age_wob=" + child_age_wob)
                        } else if (child_count_age_splited[j] > 6 && child_count_age_splited[j] <= 12) {
                            child_age_wb = child_age_wb += child_count_age_splited[j] + ',';
                            console.log("child_age_wb=" + child_age_wb)
                        } else if (child_count_age_splited[j] >= 1 && child_count_age_splited[j] <= 2) {
                            infant_age = infant_age += child_count_age_splited[j] + ',';
                            console.log("infant_age=" + infant_age)
                        }
                    }
...
function prev_step(element) {
    if (element.getAttribute("data-step") == "buyer") {
        ...
        } else if (document.querySelector(".main-container").getAttribute("data-schemaid") == 251 && document.querySelector(".provider").value == 82) {
            document.querySelector(".services-info-content").classList.remove("unvisible");
            document.querySelector(".summary-info-content").classList.add("unvisible");
            document.querySelector(".step-title").innerText = 'Service & Transfer';
        ...
        if (document.getElementsByClassName("service-info-content")[0] || (document.querySelector(".main-container").getAttribute("data-schemaid") == 290251 && document.querySelector(".provider").value == 82)) {
            document.querySelector(".services-info-content").classList.remove("unvisible");
            document.querySelector(".insurances-info-content").classList.add("unvisible");
            document.querySelector(".step-title").innerText = 'Service & Transfer';
            element.setAttribute("data-step", "service");
...
function credit_payment() {
    ...
    if (document.querySelector(".totalcom-section").querySelector(".totalcom-price")) {
        ...
        totalcom = document.querySelector(".firstpay-section").querySelector(".firstpay-price").innerText.replace(/\,/g, '');
    }
        ...
        if (document.querySelector(".transfer-hotel-content")) {
            ...
            for (var i = 0; i < document.querySelector(".transfer-hotel-content").querySelector(".departure").querySelector(".datepicker").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
                data_year_service.push({
                    "date_value": `${document.querySelector(".transfer-hotel-content").querySelector(".departure").querySelector(".datepicker").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                    "date_id": `${document.querySelector(".transfer-hotel-content").querySelector(".departure").querySelector(".datepicker").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`
...
//<!------LOAD UPLOAD INFO------->//
$(".upload-info").load('/Upload_Info.bc', function () {
    ...
    if (todo == 'default') {
        ...
        if (document.getElementsByClassName("passenger-info-content")[0].querySelector(".passportIssueDate")) {
            for (var i = 0; i < document.getElementsByClassName("passenger-info-content")[0].querySelector(".passportIssueDate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item").length; i++) {
                data_year_visa.push({
                    "date_value": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".passportIssueDate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-value")}`,
                    "date_id": `${document.getElementsByClassName("passenger-info-content")[0].querySelector(".passportIssueDate").closest(".package-info-item").querySelector(".year").closest(".passenger-date-item").querySelector(".drop-item").getElementsByClassName("li-item")[i].getAttribute("data-id")}`
...
if (document.querySelector(".main-container").getAttribute("data-schemaid") == 501) {
    ...
    function show_service_date() {
        $(".service-date-item").each(function () {
            ...
            $(this).append(`<div class="passenger-date-items"><div class="passenger-date-item has-select"><div class="inner-item"><input type="text"  onclick="toggle_date(this,'day')" placeholder="Day" class="day necessary" oninput="autoComplete_search(event,this,'day')" onblur="autoFill_search(event,this,'passenger-date-item')"  onkeyup="this.value=this.value.replace(/[^0-9]/g, ''),tab_key(event,this);" data-id="${service_dep_date_splited[2] ? service_dep_date_splited[2] : ''}" value="${service_dep_date_splited[2] ? service_dep_date_splited[2] : ''}" /></div>
            <ul class="drop-item">
             <li onclick="select_date_val(this)" class="li-item" data-id="01" data-value="1">1</li>
             <li onclick="select_date_val(this)" class="li-item" data-id="02" data-value="2">2</li>
             <li onclick="select_date_val(this)" class="li-item" data-id="03" data-value="3">3</li>
